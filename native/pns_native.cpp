...
JNIEXPORT jint JNICALL Java_dev_pointandshoot_AltReferenceAppNativeStill_nativeAltReferenceAppDngEncodeVersion(
        JNIEnv*, jclass) {
    // Stub: real AltReferenceApp-class DNG encode (Adobe DNG SDK / RawEncoder) not linked yet.
    return 0;
}
