...
/**
 * Optional **External Camera App–style** AF settle: after [CameraCaptureSession.stopRepeating], issue one or
 ...
 *
 * This is not a full ExternalCameraApp state machine — only a narrow polling loop for fleet triage on
 * tele / tripod softness when [StillCaptureAfFreeze] alone is insufficient.
 */
object StillCaptureExternalCameraAppAfSettle {
