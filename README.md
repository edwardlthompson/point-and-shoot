...
| Native diagnostics (Phase 0 fallback) | | |
|---|---|---|
| <img src="docs/screenshots/smoke_native_diag.png" alt="Native diagnostics" width="220"> | | |
