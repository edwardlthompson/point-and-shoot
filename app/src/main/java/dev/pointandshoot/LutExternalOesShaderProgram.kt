...
class LutExternalOesShaderProgram private constructor(
    ...
    object Source {
        ...
        const val UNIFORM_BUF_W: String = "uBufW"
        const val UNIFORM_BUF_H: String = "uBufH"
    ...
    fun bindPerFrameUniforms(
        ...
        GLES20.glUniform1f(uniformBufW, bufW.coerceAtLeast(1).toFloat())
        GLES20.glUniform1f(uniformBufH, bufH.coerceAtLeast(1).toFloat())
        GLES20.glUniform1f(uniformCoverCrop, if (coverCrop) 1f else 0f)
        GLES20.glUniform1f(uniformBufKnown, if (bufW > 0 && bufH > 0) 1f else 0f)
    ...
    companion object {
        ...
        fun create(vertSrc: String, fragSrc: String): LutExternalOesShaderProgram {
            ...
            return LutExternalOesShaderProgram(
                ...
                uniformBufW = GLES20.glGetUniformLocation(program, Source.UNIFORM_BUF_W),
                uniformBufH = GLES20.glGetUniformLocation(program, Source.UNIFORM_BUF_H),
