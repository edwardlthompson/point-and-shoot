 ...
 */
fun outputConfigurationsWithOptionalStreamUseCases(
 ...
 */
fun CameraDevice.createCaptureSessionRegularOutputs(
    surfaces: List<Surface>,
    handler: Handler,
 ...
 */
fun CameraDevice.createCaptureSessionHighSpeedOutputs(
    surfaces: List<Surface>,
    handler: Handler,
    callback: CameraCaptureSession.StateCallback,
