...
**Status:** Shipped — rear + front **stacked** GLES preview (rear top, front bottom), front `CameraDevice`, GL composite to **MediaCodec** encoder at **1920×1080** @ **30 fps**.
...
**Point & Shoot v1** uses a **vertical stack** (rear top, front bottom) in preview and in the encoded MP4 — simpler than LG PiP but same idea: one moment, two angles, one clip. PiP overlay may follow in a later sprint.
...
| Layout | **Stacked:** rear top ~50%, front bottom ~50% (full width each) |
| Resolution | **1920×1080** composite |
