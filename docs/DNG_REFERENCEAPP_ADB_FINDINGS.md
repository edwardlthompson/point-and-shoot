...
| Artifact | Path |
|----------|------|
| **New ReferenceCam DNGs** (22:57 session) | [`hfr-runs/referenceapp_reference_20260518_025813/`](../hfr-runs/referenceapp_reference_20260518_025813/) — `20260517_225732/36/39.dng`, `diff_report.md` |
| Logcat + dumpsys (post-capture) | [`hfr-runs/referenceapp_adb_forensics_20260518_025806/`](../hfr-runs/referenceapp_adb_forensics_20260518_025806/) — `referenceapp_capture_logcat.txt`, `dumpsys_media_camera_grep.txt` |
...
Earlier reference pull: `hfr-runs/referenceapp_reference_20260518_025412/`.
...
Scripts: `scripts/pns_referenceapp_dng_reference_pull.ps1`, `scripts/pns_referenceapp_adb_forensics.ps1`.
