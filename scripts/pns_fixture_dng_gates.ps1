<#
.SYNOPSIS
  Host-only CI gate: dng_desktop_open_gate + informational parity on tests/fixtures/proshot_cph2655.
...
Write-Host "[fixture_gates] dng_desktop_open_gate.py (ProShot refs: skip wide-cal leak)..." -ForegroundColor Cyan
