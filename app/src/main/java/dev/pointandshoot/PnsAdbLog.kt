 ...
 * overhead unless diagnostics are enabled. Debuggable builds and [DiagnosticsMode] always emit.
 */
object PnsAdbLog {
    ...
    fun isEnabled(context: Context): Boolean {
        ...
        return runCatching { DiagnosticsMode.isEnabled(app) }.getOrDefault(false)
    }
