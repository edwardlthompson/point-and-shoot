...
object FleetPolicyPreferences {
    ...
    private const val KEY_LEGACY_LegacyDevice = "legacy_device_fleet_policy_enabled"

    fun legacyOp13Enabled(context: Context): Boolean =
        context.applicationContext
            .getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_LEGACY_LegacyDevice, false)

    fun setLegacyOp13Enabled(context: Context, enabled: Boolean) {
        context.applicationContext
            .getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean(KEY_LEGACY_LegacyDevice, enabled)
            .apply()
    }
}
