...
| **Video** | H.264/HEVC MP4; HFR @ 120 fps (720p HS capture on legacy device); 10-bit + DCG; manual bitrate scale 50–150% |
| **RAW video** | `.mcraw` (`PNMRAWV1`) preview-session lane on legacy device leaf cameras |
...
- **OS:** LineageOS 23 / Android 16 (API 36) — primary validation device `legacy serial`
